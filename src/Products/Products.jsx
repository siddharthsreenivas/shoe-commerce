    ...
    <>
      <section className='flex flex-wrap ml-80 mt-8 gap-6'>
        ...
        <section className=' p-5 cursor-pointer rounded-lg border-[2px] border-[#ededed]'>
          <img src="https://m.media-amazon.com/images/I/6125yAfsJKL._AC_UX575_.jpg" alt="Shoe" className='w-48 mb-4' />
          <div>
            <h3 className='mb-2'>Title</h3>
            <section className='flex mb-2 items-center'>
              <AiFillStar color='#d5ab55' /> <AiFillStar color='#d5ab55' /> <AiFillStar color='#d5ab55' /> <AiFillStar color='#d5ab55' />
